...
from dataset.dataset_step2_continuous_50_ned_pair import FramesWavsDatasetMEL25VoxBoxQG2ImgPrompt as FramesWavsDatasetMEL25
...
from train.train_transformer import train_batch_deepprompt_eam3d_sidetuning as train
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="config\ned_pair.yaml", help="path to config")
    parser.add_argument("--mode", default="train", choices=["train", "test"])
    parser.add_argument("--gen", default="spade", choices=["original", "spade"])
    parser.add_argument("--log_dir", default='./output/debugs', help="path to log into")
    parser.add_argument("--checkpoint", default='ckpt/qvt_img_pca_sync_4_01_11_304.pth.tar', help="path to checkpoint to restore")
