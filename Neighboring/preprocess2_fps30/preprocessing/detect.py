...
def smooth_boxes(boxes, previous_box, args):
    ...
    # Smoothen boxes
    old_boxes = np.array(boxes).astype(np.uint16)
    window_length = min(args.window_length, old_boxes.shape[0])
    if window_length % 2 == 0:
        window_length -= 1
    smooth_boxes = np.concatenate(
        [ndimage.median_filter(old_boxes[:, i], size=window_length, mode='reflect').reshape((-1, 1)) for i in range(4)], 1)
    # Make boxes square.
...
def main():
    ...
    parser.add_argument('--save_videos_info',
                        action='store_true',
    ...
    parser.add_argument('--height_recentre',
                        default=0.0,
                        type=float,
    ...
    if os.path.isdir(images_dir):
        ...
        frame_info_txt = open(os.path.join(videos_path, '_frame_info.txt'), 'w')

        # Initialize the MTCNN face  detector.
        detector = MTCNN(image_size=args.cropped_image_size,
        ...
        n_completed = 0
        start_i = 0
        for path in sorted(mp4_paths):
            n_completed += 1
            start_i, frame_infos = detect_and_save_faces(detector, path, args.split, start_i, args)
            frame_info_txt.writelines(frame_infos)
...
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_01
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_02
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_03
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_04
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_05
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/Actor_06

#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_01
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_02
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_03
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_04
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_05
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/datasets/RAVDESS_Celeb/test/neutral/Actor_06
    
#python  preprocessing/detect.py --celeb /data/2023_stu/zhenxuan/codespace/EAT_code-main/preprocess_1
