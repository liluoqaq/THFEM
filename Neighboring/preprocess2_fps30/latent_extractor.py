...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", default=None, help="path to config")
    ...
    parser.add_argument("--adapt_scale",
                        dest="adapt_scale",
                        action="store_true",
    ...
    for videoname in tqdm(trainlist):
        ...
        np.save(f'{opt.root}/latents/' + os.path.basename(videoname), [kc, he])
    print('=============done==============')
